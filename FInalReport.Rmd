...
```
Here we see what happens if agents become more willing to co-author with people with different specialties, seperated by the 'talent' of the agent. !!! <NEED TO DESCRIBE THE FANCY TALENT METRIC>
`r decay_line`
