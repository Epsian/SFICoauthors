...
# Literature Review
  ...
  One example of this exists within the co-authorship networks of academia. Co-authorship networks differ structurally across disciplines[@newman_coauthorship_2004], thus the ability for social resources to flow across these networks will also differ. It has been shown that strong, direct ties between colaborators produces higher quality research output, while working with collegues with similar research interests only influences research output[@gonzales 2013].
  
  Betweenness centrality has shown to be a particularly good predictor of preferntial treatment in a co-authorship network, as new entrants to the network approach these brokers when making their first connections[@alireza 2012].
